...
<html lang="en">
    <head>
       ...
       <link href="https://fonts.googleapis.com/css2?family=Roboto+Slab:wght@700&display=swap" rel="stylesheet">
        ...
        <!-- CSS Files -->
        <link href="css/now-ui-kit.min.css?v=1.2.0" rel="stylesheet" />
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-md-5">
                            ...
                            <div class="p-2 bd-highlight" style="margin-top: 40px">
                                <div class="card card-profile">
                                    <div class="card-avatar" style="margin: -50px auto 0;
                                  ...
                                  ">
                                        ...
                                        margin-top: 0;" src="{{asset('storage/'. $user_data->image)}}" />
                                        </a>
                        ...
                        <div class="col-md-6 ml-auto mr-auto">
                            ...
                            <h5 class="category">by {{$data->author}}</h5>
                            <h2 class="main-price" style="display:inline-block"> {{$data->price}} </h2>
                            <h5 style="display:inline-block" >  NOK </h5>
                                ...
                                <div class="card card-plain">
                                    <div class="card-header" role="tab" id="headingOne">
                                        ...
                                        <a data-toggle="collapse" data-parent="#accordion" href="#collapseOne" aria-expanded="true" aria-controls="collapseOne">
                                           Book Information<i class="now-ui-icons arrows-1_minimal-down"></i>
                                        </a>
                                        @else
                                        <a data-toggle="collapse" data-parent="#accordion" href="#collapseOne" aria-expanded="true" aria-controls="collapseOne">
                                            Note Information<i class="now-ui-icons arrows-1_minimal-down"></i>
                                         </a>
                                         @endif
                                    </div>
                                    ...
                                    <div id="collapseOne" class="collapse" role="tabpanel" aria-labelledby="headingOne">
                                        <div class="card-body">
                                            ...
                                            <p>ISBN: {{$data->isbn}} </p>
                                            @if($data->b_type == 1)
                                            <p>Book Type: Textbook</p>
                                             @elseif($data->b_type == 2)
                                            <p>Book Type: Supplemetary Book</p>
                                            @endif
                                            @endif
                                            @if($data->product_type==2)
                                            <p>Note Name: {{$data->name}}</p>
                                            <p>Written By: {{$data->author}} </p>
                                            <p>Year: {{$data->edition}}</p>
                                            @endif
                                    ...
                                    <div class="card card-background card-raised" data-background-color style="background-image: url('../assets/img/bg24.jpg')">
                                        <div class="info">
                                            ...
                                            <div class="description">
                                                ...
                                                <p>Contact them to know more about the product.</p>
                                    ...
                                    <div class="card card-background card-raised" data-background-color style="background-image: url('../assets/img/bg25.jpg')">
                                        <div class="info">
                                            ...
                                            <div class="description">
                                                ...
                                                <p>Meet at the right place to exchange your product.</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
