        ...
        <ul class="navbar-nav ml-auto">
          ...
          <li class="active nav-item dropdown">
            ...
            <div class="dropdown-menu" aria-labelledby="navbarDropdown">
              ...
              <div class="dropdown-divider"></div>
              <a class="dropdown-item" href="#"><i class="material-icons" style=" margin-right: 10px;">school</i>Tutor</a>
            </div>
          </li>
                  ...
                  <tbody>
                    ...
                    <tr>
                        ...
                        <td class="td-actions text-right">
                            <a href="/Edit_tutor" type="button" rel="tooltip" class="btn btn-info btn-link"><i class="material-icons">person</i></a>
                            <a href="/Edit_tutor" type="button" rel="tooltip" class="btn btn-success btn-link"><i class="material-icons">edit</i></a>
                            <a href="/Edit_tutor" type="button" rel="tooltip" class="btn btn-danger btn-link"><i class="material-icons">close</i></a>
                        </td>
                    </tr>
                    @endforeach
                </tbody>
